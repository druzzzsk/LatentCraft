...
def main(config_path):
    ...
    # FpVAE — scaler stats are stored in checkpoint buffers, loaded automatically
    vae = FpVAE(
    ...
    if paired_improvements:
        fig1 = plot_property_vs_similarity(
            paired_improvements,
            paired_similarities,
            title=f"FP-VAE Gradient Ascent: {target_property} improvement vs. Similarity"
        )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config", default="configs/fp_gradient_ascent.yaml")
