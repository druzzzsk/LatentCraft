...
from data.preprocessing_selfies import get_dataloaders_selfies, save_selfies_charset
...
def main(config_path):
    ...
    print("Loading data and converting SMILES → SELFIES (this may take a minute)...")
    train_loader, val_loader, charset = get_dataloaders_selfies(
    ...
    n_chars = len(charset)
    print(f"SELFIES charset size: {n_chars}, train batches: {len(train_loader)}, val batches: {len(val_loader)}")

    save_selfies_charset(charset, out_cfg["charset"])
    ...
    print(f"SelfiesVAE parameters: {n_params:,}")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config", default="configs/selfies_vae.yaml")
